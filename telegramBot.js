...
const { onChange, onCallbackQuery, onMessage, onConfirm, onCreate, onCheck } = require('./utilities/commands');
...
bot.onText(/^\/create\s+(creative|collection|conzept|colloboration)\s+(.+)$/, async (msg, match) => onCreate(bot, msg, match));
